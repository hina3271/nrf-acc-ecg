...
/****************************************************************/
 // System Commands
 #define COMMAND_WAKEUP		0x02		//Wake-up from standby mode
 #define COMMAND_STANDBY	0x04		//Enter standby mode
 #define COMMAND_RESET		0x06		//Reset the device
 #define COMMAND_START		0x08		//Start,restart (synchronize) conversions
 #define COMMAND_STOP		0x0A		//Stop conversion
 #define COMMAND_OFFSETCAL	0x1A		//

// Data Read Commands
 #define COMMAND_RDATAC		0x10		//Enable Read Data Continuous mode.
 								//This mode is the default mode at power-up.
 #define COMMAND_SDATAC		0x11		//Stop Read Data Continuously mode
 #define COMMAND_RDATA		0x12		//Read data by command; supports multiple read back.
 
 // Register Read Commands
 #define COMMAND_RREG		0x20		//Read n nnnn registers starting at address r rrrr
 								//first byte 001r rrrr (2xh)(2) - second byte 000n nnnn(2)
 #define COMMAND_WREG		0x40		//Write n nnnn registers starting at address r rrrr
